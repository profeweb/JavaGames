...
public class Knight {
    ...
    private void getTourResults() {
    	...
    	if (moveCounter == bestScore) {
    		board.displayBoard();
    		System.out.println("No success. The best score is still " + bestScore + " moves reached again on this Tour #" + tourCount + "\n");
    	}
    	else if (moveCounter > bestScore) {
    		bestScore = moveCounter;
    		board.displayBoard();
    		System.out.println("No success, but getting closer! " + bestScore + " moves reached on Tour #" + tourCount + "\n");
    	}
    }
